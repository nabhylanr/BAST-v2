...
const PDFFormFiller = () => {
  ...
  const checkboxCoordinates = {
    mcm_main: { x: 45, y: 470, page: 1 },
    mcm_approver_pending: { x: 75, y: 445, page: 1 },
    mcm_account_info: { x: 75, y: 420, page: 1 },
    mcm_transfer: { x: 75, y: 395, page: 1 },
    mcm_mass_upload: { x: 75, y: 370, page: 1 },
    mcm_payroll: { x: 108, y: 350, page: 1 },
    mcm_batch_upload: { x: 108, y: 330, page: 1 },
    mcm_bill_payment_upload: { x: 108, y: 310, page: 1 },
    mcm_mpn_payment: { x: 75, y: 285, page: 1 },
    mcm_bill_payment: { x: 75, y: 260, page: 1 },
    mcm_info_management: { x: 75, y: 235, page: 1 },
    mcm_transaction_status: { x: 108, y: 215, page: 1 },
    mcm_cut_off_time: { x: 108, y: 195, page: 1 },
    mcm_template_format: { x: 75, y: 170, page: 1 },
    mcm_help_desk: { x: 75, y: 145, page: 1 },
    mcm_others: { x: 75, y: 120, page: 1 },
